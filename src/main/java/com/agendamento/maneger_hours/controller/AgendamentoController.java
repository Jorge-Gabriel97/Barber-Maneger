package com.agendamento.maneger_hours.controller;

import com.agendamento.maneger_hours.infrastructure.entity.Agendamento;
import com.agendamento.maneger_hours.services.AgendamentoService;
...
public class AgendamentoController {
    ...
    public ResponseEntity<Agendamento> alterarAgendamentos(
            ...
            @RequestParam("dataHoraAgendamento") LocalDateTime dateTime) {

        return ResponseEntity.accepted().body(agendamentoService.alterarAgendamento(agendamento, cliente, dateTime));
    }
}